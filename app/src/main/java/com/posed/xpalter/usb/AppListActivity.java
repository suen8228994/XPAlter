...
import com.posed.xpalter.usb.adapter.appListRecyclerViewAdapter;
import com.posed.xpalter.usb.model.Application;
...
public class AppListActivity extends AppCompatActivity {
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle("Attention")
					...
					.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							if (box.isChecked()) {
								PreferenceManager.getDefaultSharedPreferences(AppListActivity.this).edit().putBoolean(PREFERENCE_KEY_NEVER_SHOW_DISCLAIMER, true).apply();
							}
						}
					});
	...
	private class LoadAppListAsyncTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			progressDialog = ProgressDialog.show(AppListActivity.this, null, "Loading Packages ... ");
			appList = new ArrayList<>();
			packageManager = AppListActivity.this.getPackageManager();
		...
		protected void onPostExecute(Void aVoid) {
			recyclerViewAdapter = new appListRecyclerViewAdapter(AppListActivity.this, appList, tickedPackages, sharedPreferences);
